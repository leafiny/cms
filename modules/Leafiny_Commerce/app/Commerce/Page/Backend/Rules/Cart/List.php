...
/**
 * Class Commerce_Page_Backend_Rules_Cart_List
 */
class Commerce_Page_Backend_Rules_Cart_List extends Backend_Page_Admin_List
{
    /**
     * Retrieve type label
     *
    ...
    {
        /** @var Commerce_Helper_Cart_Rule $helper */
