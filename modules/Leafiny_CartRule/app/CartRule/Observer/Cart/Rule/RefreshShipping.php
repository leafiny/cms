...
/**
 * Class CartRule_Observer_Cart_Rule_RefreshShipping
 */
class CartRule_Observer_Cart_Rule_RefreshShipping extends Core_Observer implements Core_Interface_Observer
{
    /**
     * Gift specific data
     *
    ...
    public function execute(Leafiny_Object $object): void
    {
        ...
        if ($sale) {
            /** @var CartRule_Helper_Cart_Rule $helperCartRule */
            ...
            if ($method->getData('_estimate')) {
                try {
                    ...
                    $filters = [
                        [
                            'column' => 'type',
                            'value'  => CartRule_Model_Cart_Rule::TYPE_PERCENT_SHIPPING,
                        ],
                        [
                            'column' => 'has_coupon',
                            'value'  => 0,
